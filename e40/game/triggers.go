	...
	return map[string]*awakengine.Trigger{
		"startGame": {
			Dialogues: []awakengine.DialogueLine{
				...
				{Avatar: avatarAwakeman, Text: `It's not you, Ducky. I'm glad my ear isn't being talked off by Alamore, but at the expense of my phone being dead.`},
				{Avatar: avatarDucky, Text: `Quaaaaack.`},
				{Avatar: avatarAwakeman, Text: `It was my light source.`},
				{Avatar: avatarAwakeman, Text: `. . .`, Slowness: 4},
				{Avatar: avatarAwakeman, Text: `Hey, don't suppose you have a light?`},
		...
		"it's dark in here": {
			...
			Dialogues: []awakengine.DialogueLine{
				{Avatar: avatarAwakeman, Text: `My sight seems to have adjusted to the dark.`},
				{Avatar: avatarAwakeman, Text: `. . .`, Slowness: 4},
